...
class RedDetectionPipeline : OpenCvPipeline() {
    // Output data
    var angle: Double = 0.0
    var hasDetection: Boolean = false

    // Processing constants
    private val RED_LOWER = Scalar(0.0, 100.0, 100.0)  // HSV lower bounds
    private val RED_UPPER = Scalar(10.0, 255.0, 255.0) // HSV upper bounds
    ...
    override fun processFrame(input: Mat): Mat {
        ...
        Core.inRange(hsvMat, RED_LOWER, RED_UPPER, maskMat)
